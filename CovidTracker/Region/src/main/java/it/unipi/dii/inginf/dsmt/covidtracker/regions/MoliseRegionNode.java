...
import it.unipi.dii.inginf.dsmt.covidtracker.intfs.regionInterfaces.RegionMolise;
...
@Stateful(name = "MoliseRegionEJB")
public class MoliseRegionNode extends GenericRegionNode implements RegionMolise {
    @PostConstruct
    public void init(){
        try {
            myName = "molise";
