...
import it.unipi.dii.inginf.dsmt.covidtracker.intfs.regionInterfaces.RegionLombardia;
...
@Stateful(name = "LombardiaRegionEJB")
public class LombardiaRegionNode extends GenericRegionNode implements RegionLombardia {
    @PostConstruct
    public void init(){
        try {
            myName = "lombardia";
