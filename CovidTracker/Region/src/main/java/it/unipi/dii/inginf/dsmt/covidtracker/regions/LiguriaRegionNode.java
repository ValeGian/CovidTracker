...
import it.unipi.dii.inginf.dsmt.covidtracker.intfs.regionInterfaces.RegionLiguria;
...
@Stateful(name = "LiguriaRegionEJB")
public class LiguriaRegionNode extends GenericRegionNode implements RegionLiguria {
    @PostConstruct
    public void init(){
        try {
