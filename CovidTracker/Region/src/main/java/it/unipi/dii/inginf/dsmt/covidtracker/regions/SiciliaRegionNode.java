...
import it.unipi.dii.inginf.dsmt.covidtracker.intfs.regionInterfaces.RegionSicilia;
...
@Stateful(name = "SiciliaRegionEJB")
public class SiciliaRegionNode extends GenericRegionNode implements RegionSicilia {
    @PostConstruct
    public void init(){
        try {
            myName = "sicilia";
