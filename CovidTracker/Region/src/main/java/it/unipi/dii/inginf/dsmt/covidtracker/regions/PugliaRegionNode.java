...
import it.unipi.dii.inginf.dsmt.covidtracker.intfs.regionInterfaces.RegionPuglia;
...
@Stateful(name = "PugliaRegionEJB")
public class PugliaRegionNode extends GenericRegionNode implements RegionPuglia {
    @PostConstruct
    public void init(){
        try {
            myName = "puglia";
