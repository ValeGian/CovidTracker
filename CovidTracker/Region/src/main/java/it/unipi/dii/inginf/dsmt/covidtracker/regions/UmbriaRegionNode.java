...
import it.unipi.dii.inginf.dsmt.covidtracker.intfs.regionInterfaces.RegionUmbria;
...
@Stateful(name = "UmbriaRegionEJB")
public class UmbriaRegionNode extends GenericRegionNode implements RegionUmbria {
    @PostConstruct
    public void init(){
        try {
            myName = "umbria";
