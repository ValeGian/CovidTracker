...
import it.unipi.dii.inginf.dsmt.covidtracker.intfs.regionInterfaces.RegionTrentinoAltoAdige;
...
@Stateful(name = "TrentinoAltoAdigeRegionEJB")
public class TrentinoAltoAdigeRegionNode extends GenericRegionNode implements RegionTrentinoAltoAdige {
    @PostConstruct
    public void init(){
        try {
            myName = "trentinoaltoadige";
